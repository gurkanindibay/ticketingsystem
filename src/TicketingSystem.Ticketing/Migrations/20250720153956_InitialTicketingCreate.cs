...
{
    /// <inheritdoc />
    public partial class InitialTicketingCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventTicketTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventTicketTransactions_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventTickets_TransactionId",
                table: "EventTickets",
                column: "TransactionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EventTickets_UserId_EventId",
                table: "EventTickets",
                columns: new[] { "UserId", "EventId" });

            migrationBuilder.CreateIndex(
                name: "IX_EventTicketTransactions_EventId",
                table: "EventTicketTransactions",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventTicketTransactions_Status",
                table: "EventTicketTransactions",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_EventTicketTransactions_TransactionId",
                table: "EventTicketTransactions",
                column: "TransactionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EventTicketTransactions_UserId_EventId",
                table: "EventTicketTransactions",
                columns: new[] { "UserId", "EventId" });
